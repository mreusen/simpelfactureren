package nl.reusenit.simpelfactureren.config;
...
@ComponentScan(basePackages = { "nl.reusenit.simpelfactureren.service", 
		"nl.reusenit.simpelfactureren.repository", "nl.reusenit.simpelfactureren.domain.support" })
