...
<form:form method="POST" modelAttribute="klant">
	<input type="hidden" name="_method" value="PUT" />
	<form:input type="hidden" path="id" />
	<fieldset>
		<legend><spring:message code="klant.info"/></legend>
		<table>
			<tr>
				<td><form:label path="naam" cssErrorClass="error"><spring:message code="klant.name" /></form:label></td>
				<td><form:input path="naam" /></td>
				<td><form:errors path="naam"/></td></tr>
			<tr>
			...
			<tr>
				...
				<td><form:errors path="adres.land"/></td></tr>
			<tr>
				<td><form:label path="emailAdres" cssErrorClass="error"><spring:message code="klant.email" /></form:label></td>
				<td><form:input path="emailAdres" /></td><td><form:errors path="emailAdres"/></td>
				</tr>
			<tr>
				<td><form:label path="telefoonnr" cssErrorClass="error"><spring:message code="klant.telefoonnr" /></form:label></td>
				<td><form:input path="telefoonnr" /></td>
				<td><form:errors path="telefoonnr"/></td>
			</tr>
			<tr>
				<td><form:label path="alias" cssErrorClass="error"><spring:message code="klant.alias" /></form:label></td>
				<td><form:input path="alias" /></td>
				<td><form:errors path="alias"/></td>
			</tr>
		</table>
	</fieldset>
